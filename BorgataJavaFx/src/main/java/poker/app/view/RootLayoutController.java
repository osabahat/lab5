...
public class RootLayoutController implements Initializable {
    ...
    //toggle buttons for radio menu items
    @FXML
    private ToggleButton fiveCardJoker;
    @FXML
    private ToggleButton fiveCardWild;
    @FXML
    private ToggleButton fiveCardDraw;
    @FXML
    private ToggleButton sevenCardDraw;
    @FXML
    private ToggleButton holdem;
    @FXML
    private ToggleButton omaha;
