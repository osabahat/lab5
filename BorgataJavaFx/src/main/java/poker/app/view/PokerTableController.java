...
public class PokerTableController {
	...
	/*
	 * this code is supposed to check the current rule. we used a listener, but
	 * it keeps trying to remove the listener instead of adding it and we werent
	 * sure why that was happening.
	 */
	private void checkRule() {
		// default is five stud
		...
		CheckMenuItem item3 = new CheckMenuItem("5 Card Wild Card Joker");
		...
		CheckMenuItem item4 = new CheckMenuItem("5 Card Draw");
		...
		CheckMenuItem item5 = new CheckMenuItem("7 Card Draw");
		...
		CheckMenuItem item6 = new CheckMenuItem("Texas Hold'em");
		...
		CheckMenuItem item7 = new CheckMenuItem("Omaha");
	...
	// implementation for winner screen, we couldn't figure out how to show the
	// actual
	// winner though
	private void winnerScreen(Stage stage) {
		if (eGameState == eGameState.EndOfGame) {
			Button btn = new Button("Winner is: ");
